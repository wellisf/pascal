...
Type
{Bloco para criação dos TIPOS}
      TChave = integer;
      TItem = record  {Criando um registro de Inteiros}
                Chave : TChave;
              end;
     TIndice = 0 .. n;  {indica o tamanho do vetor}
     TVet = array [TIndice] of TItem;  {Vetor que contém registros de inteiros}
